...
class AppTheme {
  static const Color cBg = Color(0xFF090B10);
  static const Color cSurface = Color(0xFF121520);
  static const Color cEdge = Color(0xFF1E2335);
  static const Color cAccent = Color(0xFF6366F1);
  static const Color cAccent2 = Color(0xFF818CF8);
  static const Color cInk = Color(0xFFEEF2FF);
